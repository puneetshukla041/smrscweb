...
const Section3 = () => {
  ...
  useEffect(() => {
    const handleResize = () => {
      // Switch to mobile images if width is less than 768px (standard md breakpoint)
    ...
    >
      ...
      <div className="relative w-full min-h-screen flex flex-col items-center justify-center px-6 pt-10 md:pt-20 pb-10">
        ...
        <div className="relative z-10 flex flex-col items-center space-y-8 md:space-y-12 w-full">
          ...
          <motion.h2 variants={itemVariants} style={textStyle} className="text-3xl md:text-6xl px-4">
      ...
      >
        <div className="relative flex items-center justify-center w-full overflow-visible px-4 md:px-10">
          ...
          {/* Slider Frame */}
          {/* UPDATED: Mobile dimensions hardcoded, Desktop dimensions preserved via md: prefix */}
          <div 

...
const Section5 = () => {
  ...
  useEffect(() => {
    const interval = setInterval(() => { setMobileShowCount((prev) => !prev); }, 3000);
  ...
  const images = [
    ...
    { id: 2, src: "/images/home/section5/image2.webp", mobileSrc: "/images/home/section5/mob2.webp", title: "Advanced Robotics" },
    { id: 3, src: "/images/home/section5/image3.webp", mobileSrc: "/images/home/section5/mob3.webp", title: "Precision Control" },
  ...
  const getPosition = (index) => {
    ...
    if (diff === 0) return "center"; if (diff === -1) return "left"; if (diff === 1) return "right"; if (diff < -1) return "far-left"; return "far-right";
  };
